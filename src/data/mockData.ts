...
export const mockGroups: StudentGroup[] = [
  {
    ...
    description:
      "Representação estudantil do curso de Medicina, promovendo eventos acadêmicos e culturais.",
    ...
    members: [
      ...
      },
      {
        id: "s3",
        name: "Maria Clara",
        email: "maria.clara@aluno.edu.br",
        role: "member",
      },
    ],
    status: "active",
  ...
  },
  {
    ...
    members: [
      ...
      },
      {
        id: "s5",
        name: "Juliana Mendes",
        email: "juliana.mendes@aluno.edu.br",
        role: "member",
      },
    ],
    status: "active",
  ...
  },
  {
    ...
    description:
      "Associação atlética responsável pelo esporte universitário do curso de Medicina.",
    ...
    members: [
      ...
      },
      {
        ...
        email: "beatriz.almeida@aluno.edu.br",
        role: "member",
      },
      {
        id: "s8",
        name: "Thiago Martins",
        email: "thiago.martins@aluno.edu.br",
        role: "member",
      },
      {
        id: "s9",
        name: "Carolina Pereira",
        email: "carolina.pereira@aluno.edu.br",
        role: "member",
      },
    ],
    status: "active",
  ...
  },
  {
    ...
    description:
      "Liga acadêmica focada em estudos oncológicos e cuidados paliativos.",
...
// Mock opportunities created by users (for creator dashboard)
